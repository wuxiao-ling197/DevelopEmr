                ...
                <el-main>
                    ...
                    <el-form :model="config" label-width="auto">
                        ...
                        <el-row>
                            <!-- <el-col :span="12"> -->
                                <!-- children: '',//子级元素 -->
                                <!-- <el-form-item label="子级元素">
                                    <el-input v-model="config.children" />
                                </el-form-item> -->
                            <!-- </el-col> -->
                            <el-col :span="12">
                                <!-- symbol: '',//元素标识 -->
                        ...
                        <el-row>
                            <el-col :span="12">
                                ...
                                <el-form-item label="只读">
                                    ...
                                    <!-- <el-select v-model="config.readOnly">
                                        <option></option>
                                    </el-select> -->
                                </el-form-item>
                            </el-col>
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="Activity style">
                                    <el-input v-model="config.style" />
                                </el-form-item>                                    
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="Activity editStyle">
                                    <el-input v-model="config.editStyle" />
                                </el-form-item>                                   
                            </el-col>
                        </el-row>
                        ...
                        <el-form-item>
                            <el-button type="primary" @click="submitEvt">确认</el-button>
...
import { onMounted, reactive, ref } from 'vue';
    ...
    const config = reactive({
        ...
        rules:[]//校验规则，暂定结构为{name:'name1',rule:[rule1,rule2,rule3...]}
    })
